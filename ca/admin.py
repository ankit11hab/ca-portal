...
#     list_display = ('user', 'name', 'design', 'college',
#                     'contact', 'validate', 'POCscore')
...
#         self.message_user(
#             request, "All the selected PoCs have been approved successfully.")
...
#             poc.save()
#         self.message_user(
#             request, "All the selected PoCs have been disapproved successfully.")
